@5gs-initialreg5gaka-pdusess-bidirectional-dataflow @04-session-mgmt-procedures @23502-5gs @5g-core-sanity @5g-core

Feature: UE 5GS Initial Registration, PDU Session, Data Flow and UE Initiated Detach

  Scenario: UE 5GS Initial Registration with 5G AKA Authentication, Single PDU Session Establishment, Bidirectional Data flow and UE Initiated Detach
