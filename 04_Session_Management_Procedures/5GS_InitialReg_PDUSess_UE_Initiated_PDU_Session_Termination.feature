@5gs-initialreg5gaka-pdusess-estd-ue-initiated-pdusess-termination @04-session-mgmt-procedures @23502-5gs @5g-core-sanity @5g-core

Feature: 5GS Initial Registration, PDU Session Establishment and UE Initiated PDU Session Termination

  Scenario: 5GS Initial Registration with 5G AKA, Single PDU Session Establishment and UE Initiated PDU Session Termination
...
### Single PDU Session Establishment
    ...
    When I send HTTPV2 message HTTPV2_NSMF_CREATE_SM_CONTEXT_REQ on interface N11 with the following details from node AMF1 to SMF1:
      ...
      | multipart_related.json_data.sm_context_create_data.sm_context_status_uri                                    | /$({abotprop.AMF1.SecureShell.IPAddress}):$({abotprop.AMF1.N11.Server.Port})/nsmf-pdusession/v1/sm-contexts/smctx-1/status/6 |
