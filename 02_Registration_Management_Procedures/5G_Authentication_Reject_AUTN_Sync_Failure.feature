@5g-auth-reject-autn-sync-failure @02-registration-mgmt-procedures @23502-5gs @5g-core-sanity @5g-core

Feature: UE 5GS Initial Registration Reject

  Scenario: UE 5GS Initial Registration with 5G AKA Authentication Reject due to AUTN Sync Failure
    ...
    When I run the SSH command {abotprop.SUT.DEFAULT.AMF.CONFIG} at node AMF2
    ...
    When I run the SSH command {abotprop.SUT.CUSTOM.ENB.CONFIG} and pause for {abotprop.WAIT_5_SEC} seconds at node AMF2
...
### Configuration
### Configure UDM :
### a. Consider that during UE Authentication for Initial Registration UDM uses a value for SQN, say SQN = S1 where SEQ = x and IND = y.
### b. During UE Authentication for UE Registration for Second time, configure UDM to use a value lesser than the one used before for SQN, say SQN = S2 where SEQ = x - 1, IND = y


    
### Pre Condition UE Initial Registration and Deregistration
...
### UE Security Context Setup
    ...
    When I send NGAP message NG_UPLINK_NAS_DEREGIS_REQ on interface N1-N2 with the following details from node gNodeB1 to AMF1:
      | parameter                                                                       | value                                      |
      | amf_ue_ngap_id                                                                  | $(AMF_UE_NGAP_ID)                          |
      | ran_ue_ngap_id                                                                  | $(RAN_UE_NGAP_ID)                          |
      | nas_pdu.extended_protocol_discriminator                                         | {abotprop.SUT.NAS.EDP}                     |
      | nas_pdu.security_header_type                                                    | {abotprop.SUT.NAS.SEC.HEAD.INTEGRITY}      |
      | nas_pdu.message_type                                                            | {abotprop.SUT.NAS.DEREG.REQ.MSG}           |
      | nas_pdu.deregistration_request.deregistration_type                              | {abotprop.SUT.NAS.DEREG_TYPE.3GPP_NORMAL}  |
      | nas_pdu.deregistration_request.5gs_mobile_identity                              | {abotprop.SUT.NAS.5GS.MOB.IDN}             |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.type_of_id                     | {abotprop.SUT.NAS.5GS_MOB_ID.TYPE.5G-GUTI} |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.mcc                    | $(MCC)                                     |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.mnc                    | $(MNC)                                     |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.amf_region_id          | $(AMF_REGION_ID)                           |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.amf_set_id             | $(AMF_SET_ID)                              |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.amf_pointer            | $(AMF_POINTER)                             |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.5g_tmsi                | $(5G_TMSI)                                 |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mcc    | {abotprop.SUT.MCC}                         |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mnc    | {abotprop.SUT.MNC}                         |
      | user_location_information.nr_user_location_information.tai.tac                  | {abotprop.SUT.TAC}                         |
      | user_location_information.nr_user_location_information.nr_cgi.plmn_identity.mcc | {abotprop.SUT.MCC}                         |
    ...
    Then I receive and validate NGAP message NG_UPLINK_NAS_DEREGIS_REQ on interface N1-N2 with the following details on node AMF1 from gNodeB1:
      | parameter                                                                       | value                                                  |
      | amf_ue_ngap_id                                                                  | {string:eq}($(AMF_UE_NGAP_ID))                         |
      | ran_ue_ngap_id                                                                  | {string:eq}($(RAN_UE_NGAP_ID))                         |
      | nas_pdu.extended_protocol_discriminator                                         | {string:eq}({abotprop.SUT.NAS.EDP})                    |
      | nas_pdu.security_header_type                                                    | {string:eq}({abotprop.SUT.NAS.SEC.HEAD.INTEGRITY})     |
      | nas_pdu.message_type                                                            | {string:eq}({abotprop.SUT.NAS.DEREG.REQ.MSG})          |
      | nas_pdu.deregistration_request.deregistration_type                              | {string:eq}({abotprop.SUT.NAS.DEREG_TYPE.3GPP_NORMAL}) |
      | nas_pdu.deregistration_request.5gs_mobile_identity                              | save(MOB_IDENTITY)                                     |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.type_of_id                     | 0x02                                                   |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.mcc                    | save(MCC)                                              |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.mnc                    | save(MNC)                                              |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.amf_region_id          | save(AMF_REGION_ID)                                    |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.amf_set_id             | save(AMF_SET_ID)                                       |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.amf_pointer            | save(AMF_POINTER)                                      |
      #| nas_pdu.deregistration_request.5gs_mob_id_choice.5g_guti.5g_tmsi                | save(5G_TMSI)                                          |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mcc    | {string:eq}({abotprop.SUT.MCC})                        |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mnc    | {string:eq}({abotprop.SUT.MNC})                        |
      | user_location_information.nr_user_location_information.tai.tac                  | {string:eq}({abotprop.SUT.TAC})                        |
      | user_location_information.nr_user_location_information.nr_cgi.plmn_identity.mcc | {string:eq}({abotprop.SUT.MCC})                        |
    ...
    When I send NGAP message NG_DOWNLINK_NAS_DEREGIS_ACC on interface N1-N2 with the following details from node AMF1 to gNodeB1:
      | parameter                               | value                                 |
      | amf_ue_ngap_id                          | $(AMF_UE_NGAP_ID)                     |
      | ran_ue_ngap_id                          | $(RAN_UE_NGAP_ID)                     |
      | nas_pdu.extended_protocol_discriminator | {abotprop.SUT.NAS.EDP}                |
      | nas_pdu.security_header_type            | {abotprop.SUT.NAS.SEC.HEAD.INTEGRITY} |
      | nas_pdu.message_type                    | {abotprop.SUT.NAS.DEREG.ACC.MSG}      |

    Then I receive and validate NGAP message NG_DOWNLINK_NAS_DEREGIS_ACC on interface N1-N2 with the following details on node gNodeB1 from AMF1:
      | parameter                               | value                                              |
      | amf_ue_ngap_id                          | {string:eq}($(AMF_UE_NGAP_ID))                     |
      | ran_ue_ngap_id                          | {string:eq}($(RAN_UE_NGAP_ID))                     |
      | nas_pdu.extended_protocol_discriminator | {string:eq}({abotprop.SUT.NAS.EDP})                |
      | nas_pdu.security_header_type            | {string:eq}({abotprop.SUT.NAS.SEC.HEAD.INTEGRITY}) |
      | nas_pdu.message_type                    | {string:eq}({abotprop.SUT.NAS.DEREG.ACC.MSG})      |
...
##### Second Registration
    ...
    When I send NGAP message NG_INIT_UE_MSG_NAS_REGIS_REQ on interface N1-N2 with the following details from node gNodeB1 to AMF1:
      | parameter                                                                       | value                                      |
      | ran_ue_ngap_id                                                                  | incr({abotprop.SUT.RAN.UE.NGAP.ID},2)      |
      | nas_pdu.extended_protocol_discriminator                                         | {abotprop.SUT.NAS.EDP}                     |
      | nas_pdu.security_header_type                                                    | {abotprop.SUT.NAS.SEC.HEAD.PLAIN}          |
      | nas_pdu.message_type                                                            | {abotprop.SUT.NAS.REG.REQ.MSG}             |
      | nas_pdu.registration_request.5gs_registration_type                              | {abotprop.SUT.NAS.5GS.REG.TYPE.INI.REG}    |
      | nas_pdu.registration_request.nas_key_set_identifier                             | {abotprop.SUT.NAS.KSI}                     |
      | nas_pdu.registration_request.5gs_mob_id_choice.type_of_id                       | {abotprop.SUT.NAS.5GS_MOB_ID.TYPE.5G-GUTI} |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.mcc                      | {abotprop.SUT.MCC}                         |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.mnc                      | {abotprop.SUT.MNC}                         |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.amf_region_id            | {abotprop.SUT.GUAMI.AMF.REGION.ID}         |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.amf_set_id               | {abotprop.SUT.GUAMI.AMF.SET.ID}            |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.amf_pointer              | {abotprop.SUT.GUAMI.AMF.POINTER}           |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.5g_tmsi                  | $(5G_TMSI)                                 |
      | nas_pdu.registration_request.5gmm_capability                                    | {abotprop.SUT.NAS.5GMM.CAPA}               |
      | nas_pdu.registration_request.ue_security_capability                             | {abotprop.SUT.NAS.UE.SEC.CAPA}             |
      | nas_pdu.registration_request.nssai                                              | {abotprop.SUT.NAS.NSSAI}                   |
      | nas_pdu.registration_request.5gs_tracking_area_identity                         | {abotprop.SUT.NAS.5GS.TAI}                 |
    ...
    Then I receive and validate NGAP message NG_INIT_UE_MSG_NAS_REGIS_REQ on interface N1-N2 with the following details on node AMF1 from gNodeB1:
      ...
      | nas_pdu.message_type                                                            | {string:eq}({abotprop.SUT.NAS.REG.REQ.MSG})             |
      | nas_pdu.registration_request.5gs_registration_type                              | {string:eq}({abotprop.SUT.NAS.5GS.REG.TYPE.INI.REG})    |
      | nas_pdu.registration_request.nas_key_set_identifier                             | {string:eq}({abotprop.SUT.NAS.KSI})                     |
      | nas_pdu.registration_request.5gs_mob_id_choice.type_of_id                       | {string:eq}({abotprop.SUT.NAS.5GS_MOB_ID.TYPE.5G-GUTI}) |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.mcc                      | {string:eq}({abotprop.SUT.MCC})                         |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.mnc                      | {string:eq}({abotprop.SUT.MNC})                         |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.amf_region_id            | save(AMF_REGION_ID)                                     |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.amf_set_id               | save(AMF_SET_ID)                                        |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.amf_pointer              | save(AMF_POINTER)                                       |
      | nas_pdu.registration_request.5gs_mob_id_choice.5g_guti.5g_tmsi                  | save(5G_TMSI)                                           |
      | nas_pdu.registration_request.5gmm_capability                                    | {string:eq}({abotprop.SUT.NAS.5GMM.CAPA})               |
      | nas_pdu.registration_request.ue_security_capability                             | {string:eq}({abotprop.SUT.NAS.UE.SEC.CAPA})             |
      | nas_pdu.registration_request.nssai                                              | {string:eq}({abotprop.SUT.NAS.NSSAI})                   |
      | nas_pdu.registration_request.5gs_tracking_area_identity                         | {string:eq}({abotprop.SUT.NAS.5GS.TAI})                 |
...
### Configuration usage - 5G-AKA Authentication Vector :
### a. Basic Parameters generated :RAND, AUTN
###    - Value of SQN in AUTN :  SQN = S2 (where SEQ = x - 1 and IND = y)
### b. Parameters derived from the basic parameters above :  XRES*, KAUSF
    ...
    When I send HTTPV2 message HTTPV2_NUDM_UEAU_GEN_AUTH_DATA_RES_200 on interface N13 with the following details from node UDM1 to AUSF1:
      ...
      | authentication_info_result.authentication_vector.av_5G_he_aka.OP                   | 1006020f0a478bf6b699f15c062e42b3                                 |
      | authentication_info_result.supi                                                    | incr({abotprop.SUT.SUPI},1)                                      |
      | authentication_info_result.authentication_vector.av_5G_he_aka.seq_no               | {abotprop.SUT.5GAKA.SQN2}                                        |
      | authentication_info_request.ausf_instance_id                                       | {abotprop.SUT.AUSF1.NFINSTANCEID}                                |
...
### Cause Value -  "Sync Failure" (21)

    When I send NGAP message NG_UPLINK_NAS_AUTHENTICATION_FAILURE on interface N1-N2 with the following details from node gNodeB1 to AMF1:
      | parameter                                                                       | value                             |
      | amf_ue_ngap_id                                                                  | $(AMF_UE_NGAP_ID)                 |
      | ran_ue_ngap_id                                                                  | $(RAN_UE_NGAP_ID)                 |
      | nas_pdu.extended_protocol_discriminator                                         | {abotprop.SUT.NAS.EDP}            |
      | nas_pdu.security_header_type                                                    | {abotprop.SUT.NAS.SEC.HEAD.PLAIN} |
      | nas_pdu.message_type                                                            | {abotprop.SUT.NAS.AUTN.FAIL.MSG}  |
      | nas_pdu.authentication_failure.cause                                            | 21                                |
      | nas_pdu.authentication_failure.authentication_failure_parameter                 | 0000000000000000000000000000      |
      | nas_pdu.authentication_failure.K                                                | {abotprop.SUT.5GAKA.K}            |
      | nas_pdu.authentication_failure.OP                                               | {abotprop.SUT.5GAKA.OP}           |
      | nas_pdu.authentication_failure.rand                                             | $(5G_AKA_RAND_AT_GNB1)            |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mcc    | {abotprop.SUT.MCC}                |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mnc    | {abotprop.SUT.MNC}                |
      | user_location_information.nr_user_location_information.tai.tac                  | {abotprop.SUT.TAC}                |
      | user_location_information.nr_user_location_information.nr_cgi.plmn_identity.mcc | {abotprop.SUT.MCC}                |
    ...
    Then I receive and validate NGAP message NG_UPLINK_NAS_AUTHENTICATION_FAILURE on interface N1-N2 with the following details on node AMF1 from gNodeB1:
      | parameter                                                                       | value                                          |
      | amf_ue_ngap_id                                                                  | {string:eq}($(AMF_UE_NGAP_ID))                 |
      | ran_ue_ngap_id                                                                  | {string:eq}($(RAN_UE_NGAP_ID))                 |
      | nas_pdu.extended_protocol_discriminator                                         | {string:eq}({abotprop.SUT.NAS.EDP})            |
      | nas_pdu.security_header_type                                                    | {string:eq}({abotprop.SUT.NAS.SEC.HEAD.PLAIN}) |
      | nas_pdu.message_type                                                            | {string:eq}({abotprop.SUT.NAS.AUTN.FAIL.MSG})  |
      | nas_pdu.authentication_failure.cause                                            | {string:eq}(21)                                |
      | nas_pdu.authentication_failure.authentication_failure_parameter                 | save(AUTH_FAIL_PARAM_AUTS)                     |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mcc    | {string:eq}({abotprop.SUT.MCC})                |
      | user_location_information.nr_user_location_information.tai.plmn_identity.mnc    | {string:eq}({abotprop.SUT.MNC})                |
      | user_location_information.nr_user_location_information.tai.tac                  | {string:eq}({abotprop.SUT.TAC})                |
      | user_location_information.nr_user_location_information.nr_cgi.plmn_identity.mcc | {string:eq}({abotprop.SUT.MCC})                |
